...
function Process() {
  return (
    ...
    <div className='flex flex-col items-center justify-center'>
        ...
        <p className='w-2/3 text-center'>Sign up to create your account and access our opportunities. It's free!</p>
      </div>
      <div className='flex flex-col items-center justify-center'>
        <Image
        ...
        <p className='w-2/3 text-center'>Fill out your profile and apply for opportunities.</p>
      </div>
      <div className='flex flex-col items-center justify-center'>
        <Image
        ...
        <p className='w-2/3 text-center'>You will be contacted for an interview by the company</p>
      </div>
      <div className='flex flex-col items-center justify-center'>
        <Image
        ...
        <p className='w-2/3 text-center'>Once the interview is completed successfully, pay the AIESEC program registration fee to get approved..</p>
      </div>
      <div className='flex flex-col items-center justify-center'>
        <Image
        ...
        <p className='w-2/3 text-center'>AIESEC will now support in visa, departure and experience abroad..</p>
      </div>
