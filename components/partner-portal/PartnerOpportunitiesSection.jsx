...
const PartnerOpportunitiesSection = ({opportunities}) => {
  return (
    <section id="partneropp" className="container-fluid bg-aiesec-blue pt-12 pb-12" id="opportunities">
      ...
      <div className="container mx-auto justify-center mt-12 mb-8 flex flex-wrap gap-x-8 gap-y-8">
        {
          opportunities?.length > 0 ?
            opportunities?.map((opportunity, index) => {
              return (
                <Card
                  key={index}
                  className="w-72 rounded-xl shadow-2xl text-center p-2 hover:shadow-md transition ease-in"
