...
export default function App() {
  ...
  return (
    <Accordion variant="splitted" className="px-44">
      ...
      <AccordionItem key="2" aria-label="Accordion 2" title="What are the Opportunities of  AIESEC?" className="accordion-item">
      <p>AIESEC is an international youth-run and led, non-governmental and not-for-profit organization that provides young people with leadership development, cross-cultural internships, and global volunteer exchange experiences. The organization focuses on empowering young people to make a progressive social impact</p>
      </AccordionItem>
      <AccordionItem key="3" aria-label="Accordion 3" title="What is Global Volunteer ?" className="accordion-item">
      <p>AIESEC is an international youth-run and led, non-governmental and not-for-profit organization that provides young people with leadership development, cross-cultural internships, and global volunteer exchange experiences. The organization focuses on empowering young people to make a progressive social impact</p>
      </AccordionItem>
      <AccordionItem key="4" aria-label="Accordion 4" title="How to become an AIESEC Member?" className="accordion-item">
      <p>AIESEC is an international youth-run and led, non-governmental and not-for-profit organization that provides young people with leadership development, cross-cultural internships, and global volunteer exchange experiences. The organization focuses on empowering young people to make a progressive social impact</p>
      </AccordionItem>
    </Accordion>
  );
