...
const BlogSlide = (props) =>{
    return(
        <div className=" w-full shadow-xl shadow-grey-100 p-2 rounded-lg">
            ...
            <h2 className=" text-[13px] font-medium mt-3 px-1 font-sans leading-3">{props.headphrase}</h2>
            <p className=" font-normal text-[12px] text-aiesec-dark-grey px-2 mt-3">Lorem ipsum dolor sit amet consectetur. Risus metus hac ut sed sit scelerisque fames.</p>
            <div className=" bg-aiesec-light-grey rounded-xl grid grid-cols-9 mt-4">
                ...
                <div className=" p-3 col-span-6">
                    ...
                    <p className=" text-xs text-aiesec-dark-grey">July 14, 2022</p>
                </div>
                <div className=" mt-5">
                    <Image src={icon2}/>
                </div>
