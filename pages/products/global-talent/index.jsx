...
function Volunteer() {
  ...
  return (
    <>
      ...
      {/* Our Projects */}
      <h2 className={`text-global-talent flex justify-center text-3xl font-bold pb-14 p-8`}>Our Projects</h2>
      ...
      {/* Our Destinations */}
      <h2 className={`text-global-talent flex justify-center text-3xl font-bold pb-14 p-8`}>Our Destinations</h2>
      ...
      <br />
      <Whyvolunteer />
      <h2 className={`text-global-talent flex justify-center text-3xl font-bold pb-14 p-8`}>Process</h2>
